...
import com.quick.modules.system.service.*;
...
public class LoginController {
    ...
    public Result<JSONObject> getUserInfo(HttpServletRequest request){
        ...
        if (MyConvertUtils.isNotEmpty(userName)){
            SysUser userByName = sysUserService.getUserByName(userName);
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("userInfo",userByName);
            jsonObject.put("sysAllDictItems", sysDictService.queryAllDictItems());
    ...
    public Result<Object> logout(HttpServletRequest request, HttpServletResponse response) {
        ...
        if(MyConvertUtils.isEmpty(token)) {
            return Result.error("退出登录失败！");
        }
        String username = JwtUtil.getUsername(token);
        SysUser userByName = sysUserService.getUserByName(username);
        LoginUser sysUser = new LoginUser();
        BeanUtils.copyProperties(userByName,sysUser);
        if(sysUser!=null) {
    ...
    public Result<List<Map<String,Object>>> visitInfo() {
        ...
        result.setResult(MyConvertUtils.toLowerCasePageList(list));
        return result;
    }
    ...
    public Result<JSONObject> selectDepart(@RequestBody SysUser user) {
        ...
        if(MyConvertUtils.isEmpty(username)) {
    ...
    public Result<String> sms(@RequestBody JSONObject jsonObject) {
        ...
        log.info(mobile);
        if(MyConvertUtils.isEmpty(mobile)){
