// package com.quick.common.system.query;
//
...
// import com.quick.common.constant.SymbolConstant;
// import com.quick.common.system.util.JeecgDataAutorUtils;
...
// import com.quick.common.util.DateUtils;
// import com.quick.common.util.MyConvertUtils;
// import com.quick.common.util.SqlInjectionUtil;
...
// 			if(MyConvertUtils.isNotEmpty(c) && c.startsWith(SQL_RULES_COLUMN)){
...
// 					final String field = MyConvertUtils.camelToUnderline(column);
// 					if(vals.length>1) {
// 						queryWrapper.and(j -> {
...
// 		if (MyConvertUtils.isNotEmpty(column) && MyConvertUtils.isNotEmpty(order)) {
// 			//字典字段，去掉字典翻译文本后缀
...
// 				//queryWrapper.orderByAsc(MyConvertUtils.camelToUnderline(column));
// 				String columnStr = MyConvertUtils.camelToUnderline(column);
// 				String[] columnArray = columnStr.split(",");
// 				queryWrapper.orderByAsc(Arrays.asList(columnArray));
// 			} else {
// 				//queryWrapper.orderByDesc(MyConvertUtils.camelToUnderline(column));
// 				String columnStr = MyConvertUtils.camelToUnderline(column);
// 				String[] columnArray = columnStr.split(",");
...
// 						rule -> MyConvertUtils.isNotEmpty(rule.getField())
// 								&& MyConvertUtils.isNotEmpty(rule.getRule())
// 								&& MyConvertUtils.isNotEmpty(rule.getVal())
...
//                         if (MyConvertUtils.isNotEmpty(rule.getField())
//                                 && MyConvertUtils.isNotEmpty(rule.getRule())
//                                 && MyConvertUtils.isNotEmpty(rule.getVal())) {
//
...
// 							if (MyConvertUtils.isNotEmpty(dbType)) {
// 								try {
...
// 		if(MyConvertUtils.isNotEmpty(value)) {
...
// 		if (value == null || rule == null || MyConvertUtils.isEmpty(value)) {
// 			return;
// 		}
// 		name = MyConvertUtils.camelToUnderline(name);
...
// 		if (MyConvertUtils.isEmpty(ruleValue)) {
// 			return "";
// 		}
...
// 			return "";
// 		}
// 		field =  alias+MyConvertUtils.camelToUnderline(field);
...
// 				}
// 				String filedSql = getSingleSqlByRule(rule, MyConvertUtils.camelToUnderline(column), value,isString);
