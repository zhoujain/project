package com.quick.common.util.oss;
...
import com.quick.common.util.filter.StrAttackFilter;
...
public class OssBootUtil {
    ...
    public static String upload(MultipartFile file, String fileDir,String customBucket) {
        ...
        if(MyConvertUtils.isNotEmpty(customBucket)){
        ...
        try {
            ...
            if (MyConvertUtils.isNotEmpty(staticDomain) && staticDomain.toLowerCase().startsWith(CommonConstant.STR_HTTP)) {
...
//            ossClient.setBucketAcl(newBucket, CannedAccessControlList.PublicRead);
    ...
    */
    public static String getOriginalUrl(String url) {
        ...
        if(MyConvertUtils.isNotEmpty(staticDomain) && url.indexOf(staticDomain)!=-1){
    ...
    public static void deleteUrl(String url,String bucket) {
        String newBucket = bucketName;
        if(MyConvertUtils.isNotEmpty(bucket)){
            newBucket = bucket;
        }
        String bucketUrl = "";
        if (MyConvertUtils.isNotEmpty(staticDomain) && staticDomain.toLowerCase().startsWith(CommonConstant.STR_HTTP)) {
    ...
    private static String replacePrefix(String objectName,String customBucket){
        ...
        if(MyConvertUtils.isNotEmpty(staticDomain)){
