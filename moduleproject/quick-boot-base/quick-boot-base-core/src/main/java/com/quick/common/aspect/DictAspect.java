...
//import com.quick.common.api.CommonAPI;
...
//     * 定义切点Pointcut
//     */
//    @Pointcut("execution(public * com.quick.modules..*.*Controller.*(..)) || @annotation(com.quick.common.aspect.annotation.AutoDict)")
...
//                    for (Field field : MyConvertUtils.getAllFields(record)) {
//                        String value = item.getString(field.getName());
//                        if (MyConvertUtils.isEmpty(value)) {
//                            continue;
//                        }
...
//                        try {
//                            String text = MyConvertUtils.getString(redisTemplate.opsForValue().get(keyString));
...
//                    if (redisTemplate.hasKey(keyString)){
//                    try {
//                        tmpValue = MyConvertUtils.getString(redisTemplate.opsForValue().get(keyString));
//                    } catch (Exception e) {
//                        log.warn(e.getMessage());
//                    }
//                }else {
...
//        if(MyConvertUtils.isNotEmpty(records) && records.size()>0){
//            for (Field field : MyConvertUtils.getAllFields(records.get(0))) {
//                if (MyConvertUtils.isNotEmpty(field.getAnnotation(Dict.class))) {
//                    return true;
//                }
//            }
//        }
